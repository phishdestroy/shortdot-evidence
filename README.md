...
When NameSilo sells these domains in bulk, they are not supporting legitimate affiliates. They are actively arming operators whose sole purpose is to bypass sovereign legal blocks (such as financial or gambling regulations in Turkey, Indonesia, and elsewhere). The researchers behind this project have roots in the Russian-speaking internet — we recognize these bypass patterns intimately. Unlike a sovereign state that can retreat into digital isolationism and declare the outside world irrelevant, a globally accredited registrar operating under ICANN contract has no such option. The internet is not an isolated ecosystem. Aggressively supplying infrastructure to circumvent the laws of other nations — and systematically ignoring the resulting abuse reports — is not a neutral business practice. It is complicity. Governments do not implement legal blocks just so a registrar can sell thousands of disposable mirror domains and claim plausible deniability.
