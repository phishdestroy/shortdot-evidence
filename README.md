...
|:--|--:|--:|
| `2026-08-02` | 7,199 | **1.0×** |

### 🎯 Top Targeted Brands & Keywords

`dia (22)` &middot; `portal (20)` &middot; `hop (18)` &middot; `bonus (16)` &middot; `gaming (12)` &middot; `tron (12)` &middot; `eos (9)` &middot; `official (9)` &middot; `neo (9)` &middot; `login (9)` &middot; `drift (8)` &middot; `base (7)` &middot; `rug (5)` &middot; `service (5)` &middot; `near (4)`
...
| **All zones** | — | [deployed_all.txt](data/ioc/deployed_all.txt) 493 | [phantom_all.txt](data/ioc/phantom_all.txt) 6,706 |
