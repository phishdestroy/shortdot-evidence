...
|:--|--:|--:|
| `2026-08-01` | 6,638 | **1.0×** |

### 🎯 Top Targeted Brands & Keywords

`dia (22)` &middot; `bonus (16)` &middot; `hop (15)` &middot; `tron (14)` &middot; `official (11)` &middot; `quest (10)` &middot; `portal (6)` &middot; `eos (6)` &middot; `service (5)` &middot; `apple (5)` &middot; `connect (5)` &middot; `bank (5)` &middot; `gaming (5)` &middot; `support (4)` &middot; `profit (4)`
...
| **All zones** | — | [deployed_all.txt](data/ioc/deployed_all.txt) 0 | [phantom_all.txt](data/ioc/phantom_all.txt) 6,638 |
