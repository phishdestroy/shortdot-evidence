...
|:--|--:|--:|
| `2026-08-03` | 3,659 | **1.0×** |

### 🎯 Top Targeted Brands & Keywords

`official (18)` &middot; `bonus (14)` &middot; `dia (10)` &middot; `eos (8)` &middot; `drift (8)` &middot; `hop (7)` &middot; `neo (6)` &middot; `gaming (5)` &middot; `tron (4)` &middot; `support (4)` &middot; `rug (4)` &middot; `base (3)` &middot; `service (3)` &middot; `token (2)` &middot; `drop (2)`
...
| **All zones** | — | [deployed_all.txt](data/ioc/deployed_all.txt) 243 | [phantom_all.txt](data/ioc/phantom_all.txt) 3,416 |
