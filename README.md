...
|:--|--:|--:|
| `2026-09-08` | 10,902 | **1.0×** |

### 🎯 Top Targeted Brands & Keywords

`bonus (41)` &middot; `finance (40)` &middot; `tron (34)` &middot; `dia (26)` &middot; `hop (26)` &middot; `gaming (19)` &middot; `quest (15)` &middot; `ally (14)` &middot; `fund (12)` &middot; `service (12)` &middot; `support (12)` &middot; `amazon (10)` &middot; `wise (9)` &middot; `verify (9)` &middot; `official (8)`
...
| **All zones** | — | [deployed_all.txt](data/ioc/deployed_all.txt) 506 | [phantom_all.txt](data/ioc/phantom_all.txt) 10,396 |
